// deploy contracts/extensions/OnchainArtStorageExtension.sol
...
// const question: (q: string) => Promise<string> = util.promisify(rl.question).bind(rl);
...
const main = async () => {
    ...
    await hre.run("verify:verify", {
        ...
        constructorArguments: [nft, artwork],
    });
};
