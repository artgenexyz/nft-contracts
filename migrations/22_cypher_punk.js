...
module.exports = async function(deployer) {
  ...
  // CypherPunk: WL6
  const wl6 = await PresaleListExtension.at("0xc156e7f00f6a8a3a980fbfe5208f0bae37fba6d7");

  // CypherPunk: WL5
  const wl5 = await PresaleListExtension.at("0x65581bfccbaad498dac703c7e4462a6e3f48644b");

  // CypherPunk: Public Sale
  const lim = await LimitAmountSaleExtension.at("0x2c96802b857ce97c5f41cb9ace0f517ee5d7fa5a");

  // CypherPunk: WL3
  const wl3 = await PresaleListExtension.at("0x6dbd4dc0588bbfea07407f2d20b6c987f172ac6f");

  // CypherPunk: WL2
  const wl2 = await PresaleListExtension.at("0xfbf41fec932b3645259d4da50ab8b19e463e99f3");

  // CypherPunk: WL1
  const wl1 = await PresaleListExtension.at("0xb5eae116cd3f5013e67c283de5d66ba2f85f66b3");
