...
abstract contract ScriptyOnchainArt is ArtgeneCodeStorage {
    ...
    string private constant artScriptName = "artgene-script.js.gz";
    bytes private ART_SCRIPT;
